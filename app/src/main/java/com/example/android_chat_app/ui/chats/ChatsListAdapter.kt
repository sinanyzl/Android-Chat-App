...
import com.example.android_chat_app.databinding.ListItemChatBinding
...
class ChatsListAdapter  internal constructor(private val viewModel: ChatsViewModel) : ListAdapter<(ChatWithUserInfo), ChatsListAdapter.ViewHolder>(ChatDiffCallBack){
    ...
    class ViewHolder(private val  binding: ListAdapterChatBinding): RecyclerView.ViewHolder(binding.root){
