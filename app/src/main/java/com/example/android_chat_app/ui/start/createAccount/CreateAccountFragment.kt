...
import com.example.android_chat_app.databinding.FragmentCreateAccountBinding
import com.example.android_chat_app.ui.main.MainActivity
import com.example.android_chat_app.util.SharedPreferencesUtil
import com.example.android_chat_app.util.forceHideKeyboard
import com.example.android_chat_app.util.showSnackBar
...
class CreateAccountFragment : Fragment() {
    ...
    private fun navigateToChats(){
        findNavController().navigate(R.id.action_createdAccountFragment_tonavigation_chats)
