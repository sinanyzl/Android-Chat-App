...
import com.example.android_chat_app.databinding.FragmentUsersBinding
import com.example.android_chat_app.data.EventObserver
import com.example.android_chat_app.ui.profile.ProfileFragment


class UsersFragment : Fragment(){

    private val viewMode: UsersViewModel by viewModels { UsersViewModelFactory(App.myUserID) }
